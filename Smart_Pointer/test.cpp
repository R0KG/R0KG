...
int main() {
    ...
    ss << patient;
    if (ss.str() != "[John Doe, 30 years, {[Cardiology, Heart Attack}], 200 money]") {
    ...
    ss << *hcp;
    if (ss.str() != "[Dr. Smith, {Cardiology}, 500 money, Teacher]") {
...
ss << hospital;
if (ss.str() != "[City Hospital, hcps {[Dr. Smith, {Cardiology}, 600 money, Teacher}], patients {[John Doe, 30 years, {}, 100 money]}]") {
